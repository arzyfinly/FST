<header class="main-header header-style-nine">
                        ...
                        <div class="link-box">
                            <ul>
                                {{-- <li id="menu-item-5444"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5444">
                                    <a title="Student Registration" href="../student-registration/index.html"
                                ...
                                <li id="menu-item-5441"
                                    ...
                                    <a title="Dashboard" href="../dashboard/index.html"
                                        class="hvr-underline-from-left1" data-scroll
                            ...
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li id="menu-item-1604"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1604 current">
                                        <a title="Home" href="#" href="../college-about-us/index.html"
                                            class="hvr-underline-from-left1" aria-expanded="false" data-scroll
                                            data-options="easing: easeOutQuart" onClick="return true">Home</a>
                                    </li>
                                    ...
                                    <li id="menu-item-1605"
                                        ...
                                        <a title="Blog" href="#" data-toggle="dropdown1"
                                            class="hvr-underline-from-left1" aria-expanded="false" data-scroll
                                            data-options="easing: easeOutQuart" onClick="return true">Berita</a>
                                        <ul role="menu" class="submenu">
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo">
                <a href="../index.html" title="Educamb"><img src="../wp-content/uploads/2022/09/LogoH1.png"
                        alt="logo" style="" /></a>
            </div>
