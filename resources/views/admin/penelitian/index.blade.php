...
@section('content')
    ...
    <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <button class="btn btn-success mr-2" data-toggle="modal" data-target="#modalCreateCounseling" style="float: right"><i class="fa fa-plus"></i></button>
                </div>
          ...
          @include('admin.counselings.create')
...
@include('admin.counselings.scriptdeletedata')
@endsection
