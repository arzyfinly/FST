    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('panduan-pendidikan-fst.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('panduan-pendidikan-fst.index') }}",
                    type: 'GET',
                },
                "responsive": true,
                "language": {
        ...
        @include('admin.akademik.panduanpendidikanfst.create')
        @include('admin.akademik.panduanpendidikanfst.scriptdelete')
@endsection
