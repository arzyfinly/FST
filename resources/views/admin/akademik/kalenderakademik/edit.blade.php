        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('kalender-akademik-fst.update', $kalender->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                            ...
                                            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                                ...
                                                <div class="col-sm">
                                                    ...
                                                    <div class="input-group my-3 text-center">
                                                        <img id="output2" @isset($kalender->image_content) src="{{ asset('images/kalender-akademik-fakultas/'.$kalender->image_content) }}" @endisset class="img-thumbnail" />
                                                    </div>
                                                </div>
                                                @error('image_content')
