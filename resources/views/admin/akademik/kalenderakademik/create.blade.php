                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive p-3">
                            <form action="{{ route('kalender-akademik-fst.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="p-3 py-5">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="title" class="form-control" placeholder="ex : download kalender akademik v1.pdf">
                                                        @error('title')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
