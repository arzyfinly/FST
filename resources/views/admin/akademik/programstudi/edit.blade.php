...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Sejarah FST') }}</h1>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('program-studi-fst.update', $program_studi_fst->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="input-group my-3 text-center">
                                                <img id="output2" class="img-thumbnail" @isset($program_studi_fst->image_content) src="{{ asset('Images/program-studi-fakultas/'.$program_studi_fst->image_content) }}" @endisset @empty($program_studi_fst->image_content) src="{{ asset('Images/default/upload-image.png') }}" @endempty>
                                            </div>
                                        </div>
                                        @error('image_content')
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                ...
                                                <select name="title" class="form-control @error('title') is-invalid @enderror">
                                                    ...
                                                    <option @if ($program_studi_fst->title == "INFORMATIKA") selected @endif value="INFORMATIKA">INFORMATIKA</option>
                                                    <option @if ($program_studi_fst->title == "TEKNIK INDUSTRI") selected @endif value="TEKNIK INDUSTRI">TEKNIK INDUSTRI</option>
                                                    <option @if ($program_studi_fst->title == "SISTEM INFORMASI") selected @endif value="SISTEM INFORMASI">SISTEM INFORMASI</option>
                                                </select>
                                                @error('title')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <input value="{{ $program_studi_fst->description }}" type="text" name="description"
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <input value="{{ $program_studi_fst->date }}" type="date" name="date"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    <input @if($program_studi_fst->publish == 1) checked @endif class="form-check-input" name="publish" type="checkbox" value="1" id="checkbox-1" />
                                                    <input value="{{ $program_studi_fst->category_profile_id }}" hidden name="category_profile_id" type="text"
                                                        value="2" />
