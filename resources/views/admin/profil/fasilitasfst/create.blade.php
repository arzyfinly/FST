                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">{{ __('Create Fasilitas FST') }}</h6>
                        ...
                        <div class="table-responsive p-3">
                            <form action="{{ route('fasilitas-fst.store') }}" method="POST"
                                        ...
                                        <div class="col border-right">
                                            <div class="p-3 py-5">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h4 class="text-right">Fasilitas Fakultas</h4>
                                                </div>
                                                <div class="row mt-2">
                                                    <div class="col-md-12">
