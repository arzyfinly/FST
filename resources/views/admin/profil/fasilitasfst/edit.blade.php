@extends('layout.app')
@section('title', 'Fasilitas FST')
@section('fasilitas-fst-active', 'active')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Fasilitas FST') }}</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item">{{ __('Profil') }}</li>
            <li class="breadcrumb-item">{{ __('Fasilitas FST') }}</li>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Fasilitas FST') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('fasilitas-fst.update', $fasilitas->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="input-group my-3 text-center">
                                                <img id="output2" class="img-thumbnail" @isset($fasilitas->image_content) src="{{ asset('images/fasilitas-fakultas/'.$fasilitas->image_content) }}" @endisset @empty($fasilitas->image_content) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                            </div>
                                        </div>
                                        @error('image_content')
                                ...
                                <div class="col border-right">
                                    <div class="p-3 py-5">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="text-right">Fasilitas FST</h4>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <input value="{{ $fasilitas->description }}" type="text" name="description"
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="exampleFormControlTextarea1"
                                                    rows="4" style="font-size: 10pt"> {{ $fasilitas->content }} </textarea>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    <input @if($fasilitas->publish == 1) checked @endif class="form-check-input" name="publish" type="checkbox" value="1" id="checkbox-1" />
                                                    <input value="{{ $fasilitas->category_profile_id }}" hidden name="category_profile_id" type="text"
                                                        value="2" />
