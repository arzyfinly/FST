                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <small class="text-danger"> *Isi konten minimal 1 paragraf dan tidak lebih dari 2 paragraf  </small>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input @error('publish') is-invalid @enderror" name="publish" type="checkbox"
