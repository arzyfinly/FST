        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit VIsi Misi Tujuan FST') }}</h6>
                ...
                <div class="table-responsive p-3">
                    <form action="{{ route('visi-misi-tujuan-fst.update', $visimisi->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="input-group my-3 text-center">
                                                <img id="output2" class="img-thumbnail" @isset($visimisi->image_content) src="{{ asset('images/visi-misi-fakultas/'.$visimisi->image_content) }}" @endisset @empty($visimisi->image_content) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                            </div>
                                        </div>
                                        @error('image_content')
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="exampleFormControlTextarea1"
                                                    rows="4" style="font-size: 10pt"> {{ $visimisi->content }} </textarea>
