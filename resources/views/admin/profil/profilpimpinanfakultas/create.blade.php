                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">{{ __('Create Pimpinan FST') }}</h6>
                        ...
                        <div class="table-responsive p-3">
                            <form action="{{ route('pimpinan-fst.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="p-3 py-5">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="form-control" name="title" @error('title') is-invalid @enderror placeholder="judul">
                                                            ...
                                                            <option value="KAPRODI SISTEM INFORMASI">KAPRODI SISTEM INFORMASI</option>
                                                            <option value="KAPRODI TEKNIK INDUSTRI">KAPRODI TEKNIK INDUSTRI</option>
                                                        </select>
                                                        @error('title')
                                                            <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        <input type="text" name="content" class="form-control" placeholder="Ex: Joni A.Md.Kom.">
