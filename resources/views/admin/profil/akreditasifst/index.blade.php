...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('Akreditasi FST') }}</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('akreditasi-fst.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('akreditasi-fst.index') }}",
                    type: 'GET',
                },
                "responsive": true,
                "language": {
    ...
    @include('admin.profil.akreditasifst.create')
    @include('admin.profil.akreditasifst.scriptdelete')
@endsection
