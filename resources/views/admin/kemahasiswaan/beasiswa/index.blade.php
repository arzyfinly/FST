...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('Beasiswa FST') }}</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('beasiswa-fst.header') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <table class="ml-2" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td class="pt-4">
                                <label for="file1">
                                    <img id="output1" style="width: 100px " class="img-thumbnail" @isset($kemahasiswaan->image_header) src="{{ asset('images/beasiswa-fakultas/'.$kemahasiswaan->image_header) }}" @endisset @empty($kemahasiswaan->image_header) src="{{ asset('images/default/upload-image.png') }}" @endempty>
                                </label> <br>
